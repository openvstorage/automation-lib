...
class JsonGeneratorTestcase(unittest.TestCase):
    ...
    def test_model_ci(self):
        self.generator.update_ci(passed_required_params={'setup': True, 'grid_ip': self.ip_1})
    ...
    def test_remove_hypervisor(self):
        self.generator.update_ci(passed_required_params={'setup': True, 'grid_ip': self.ip_1})
        self.generator.add_hypervisor(hypervisor_ip=self.ip_1)
        self.generator.add_hypervisor(hypervisor_ip=self.ip_2)
        self.generator.remove_hypervisor(hypervisor_ip=self.ip_2)
        self.assertEquals(len(self.generator.config['ci']['hypervisors']), 1)
    ...
    def test_add_domain(self):
        ...
        self.assertEquals(len(self.generator.config['domains']), 2)
        with self.assertRaises(ValueError):
    ...
    def test_remove_domain(self):
        ...
        self.assertEquals(len(self.generator.config['domains']), 1)
    ...
    def test_storagerouter_addition_removal(self):
        ...
        self.assertTrue(self.ip_1 in self.generator.config['storagerouters'].keys())
        ...
        self.assertFalse(self.ip_2 in self.generator.config['storagerouters'].keys())
        ...
        self.assertTrue('disk1' in self.generator.config['storagerouters'][self.ip_1]['disks'])
        self.assertEquals(len(self.generator.config['storagerouters'][self.ip_1]['disks']['disk1']['roles']), 2)
        ...
        self.assertFalse('disk2' in self.generator.config['storagerouters'][self.ip_1])
        ...
        self.assertFalse('domain2' in self.generator.config['storagerouters'][self.ip_1])

        self.assertEquals(len(self.generator.config['storagerouters'][self.ip_1]['domains']['domain_guids']), 1)
        self.assertEquals(len(self.generator.config['storagerouters'][self.ip_1]['domains']['recovery_domain_guids']), 1)

        self.generator.add_domain_to_sr(storagerouter_ip=self.ip_1, name='domain2')
        self.generator.add_domain_to_sr(storagerouter_ip=self.ip_1, name='domain2', recovery=True)
        self.assertEquals(len(self.generator.config['storagerouters'][self.ip_1]['domains']['domain_guids']), 2)
        self.assertEquals(len(self.generator.config['storagerouters'][self.ip_1]['domains']['recovery_domain_guids']), 2)
    ...
    def test_backend_addition_removal(self):
        ...
        self.assertItemsEqual(self.generator.config['backends'][0].keys(), ['name', 'domains', 'scaling'])
        self.generator.add_backend(backend_name='mybackend02', domains=['domain1'], scaling='GLOBAL')
        self.assertItemsEqual(self.generator.config['backends'][1].keys(), ['name', 'domains', 'scaling'])

        self.generator.add_preset_to_backend(backend_name='mybackend02', preset_name='mypreset', policies=[[1, 2, 2, 1]])
        self.assertEqual(self.generator.config['backends'][1]['name'], 'mybackend02')
        with self.assertRaises(ValueError):
        ...
        self.assertEquals(len(self.generator.config['backends'][0]['osds']), 1)

        self.generator.add_osd_to_backend(backend_name='mybackend', osds_on_disks={self.ip_2: {'vdb': 2}})
        self.assertEquals(len(self.generator.config['backends'][0]['osds']), 2)

        self.generator.remove_osd_from_backend(backend_name='mybackend', osd_identifier=self.ip_2)
        self.assertEquals(len(self.generator.config['backends'][0]['osds']), 1)

        self.assertEqual(self.generator.config['backends'][0]['osds'][self.ip_1]['vdb'], 2)
        with self.assertRaises(ValueError):
        ...
        self.assertEqual(self.generator.config['backends'][1]['osds']['mybackend'], 'mypreset')
        self.generator.remove_backend('mybackend02')
        self.assertNotEquals(len(self.generator.config['backends']), 3)
    ...
    def test_vpool_addition_removal(self):
        ...
        self.assertTrue(vpoolname in self.generator.config['storagerouters'][self.ip_1]['vpools'].keys())
        self.assertTrue('storagedriver' in self.generator.config['storagerouters'][self.ip_1]['vpools'][vpoolname].keys())
        ...
        self.assertFalse('vpool1000' in self.generator.config['storagerouters'][self.ip_1]['vpools'])
    ...
    def test_full_flow(self):
        ...
        expected_output = {u'ci': {u'cleanup': False,
                                   ...
                                   u'hypervisors': {u'127.0.0.1': {u'password': u'rooter',
                                                                   u'type': u'KVM',
                                                                   u'user': u'root',
        ...
        self.assertEqual(self.generator.config['domains'], expected_output[u'domains'])
        self.assertDictEqual(self.generator.config['storagerouters'], expected_output[u'storagerouters'])
        self.assertEqual(self.generator.config['backends'], expected_output[u'backends'])
